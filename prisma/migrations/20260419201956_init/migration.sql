...
-- CreateEnum
CREATE TYPE "HospitalLevel" AS ENUM ('DISTRICT', 'PROVINCIAL', 'NATIONAL_REFERRAL');
...
-- CreateEnum
CREATE TYPE "ReferralStatus" AS ENUM ('SUBMITTED', 'ACCEPTED', 'REJECTED', 'IN_TRANSIT', 'ADMITTED', 'COUNTER_REFERRED');
